...
export const GradientCard = ({ 
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative rounded-3xl overflow-hidden w-full h-full min-h-[280px]"
      style={{
    ...
    >
      ...
      {/* Card content */}
      <motion.div
        className="relative flex flex-col h-full p-6 md:p-8 z-40"
        animate={{
          z: 2
        }}
      >
        ...
        >
          ...
          <motion.p
            className="text-xs md:text-sm mb-4 text-gray-300"
            style={{
              lineHeight: 1.5,
              fontWeight: 350,
            }}
